"""This is a 2D case of 3D experiment

The length of the tank is 40 mm, with each particle being 1.9 mm. A total of 600
particles are used.


Taken from Hu 2023 paper.
https://www.sciencedirect.com/science/article/pii/S1385894723014080#s0065
...
class Problem(Application):
    def add_user_options(self, group):
        ...
        group.add_argument("--tank-height-ratio", action="store", type=float,
                           dest="tank_height_ratio", default=2.2,
    ...
    def consume_user_options(self):
        ...
        # x - axis
        self.fluid_length = 40. * 1e-3
        # y - axis
        self.fluid_height = 20. * 1e-3
        # z - axis
        self.fluid_depth = 0.
