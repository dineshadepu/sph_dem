...
class Problem(Application):
    def add_user_options(self, group):
        ...
        group.add_argument("--rigid-body-rho", action="store", type=float,
                           dest="rigid_body_rho", default=1000,
    ...
    def consume_user_options(self):
        ...
        # self.max_rigid_body_diameter = 4. * 0.11
    ...
    def post_process(self, fname):
        ...
        plt.ylabel('Force')
        plt.legend()
        fig = os.path.join(os.path.dirname(fname), "pressure_force_vs_t.png")
        ...
        plt.ylabel('Force')
        plt.legend()
        fig = os.path.join(os.path.dirname(fname), "visc_force_vs_t.png")
        plt.savefig(fig, dpi=300)
        # ========================
        # x amplitude figure
        # ========================
